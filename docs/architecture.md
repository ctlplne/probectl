...
- **OpenTelemetry-native** (OTLP metrics/traces/logs ingest + metrics
  export — `docs/otlp.md`; traces/logs bounded for correlation, not APM).
  Signal schemas map to OTel resource + network
