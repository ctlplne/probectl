# probectl in practice — the user journeys

**Start here.** These are the end-to-end paths most people actually walk through
probectl. Each journey is a numbered, copy-along route that stitches the underlying
features together — follow one top to bottom and you'll have done a real job, not just
read about a capability. The [feature index](features.md) is the reference *behind* these
paths; the [glossary](glossary.md) defines any term you hit.
...
New to probectl? Start with **J1**, then follow each journey's "Next" pointer. Already
running it? Jump to the journey that matches the job in front of you.
