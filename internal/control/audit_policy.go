...
var auditExportRoutes = map[string]bool{
	...
	"GET /v1/compliance/auditor-bundle":       true,
	...
	"POST /v1/incidents/{id}/exports":         true,
...
var auditPolicyMatrix = map[string]auditRoutePolicy{
	...
	"POST /v1/incidents/{id}/exports":               auditExplicit(auditFacetExport, "incident.evidence_export"),
	"POST /v1/incidents/{id}/correlation-overrides": auditExplicit(auditFacetMutation, "incident.correlation_override_create"),
	"POST /v1/incidents/{id}/correlation-overrides/{override_id}/reverse": auditExplicit(auditFacetMutation, "incident.correlation_override_reverse"),
	"GET /v1/incident-shares/{id}":                                        auditExplicit(auditFacetSensitiveRead, "incident.share_read"),
	"PATCH /v1/incidents/{id}":                                            auditExplicit(auditFacetMutation, "incident.resolve|incident.reopen"),
	...
	"GET /v1/hierarchy":                                                   auditWrapped(auditFacetSensitiveRead),
	...
	"GET /v1/coverage/debt":                                               auditWrapped(auditFacetSensitiveRead),
	...
	"GET /v1/threat/rules":                                                auditWrapped(auditFacetSensitiveRead),
	"GET /v1/opendata/enrichment":                                         auditWrapped(auditFacetSensitiveRead),
	...
	"GET /v1/compliance/auditor-bundle":                                   auditWrapped(auditFacetExport),
	...
	"GET /v1/directory/users":                                             auditWrapped(auditFacetSensitiveRead),
	"POST /v1/directory/users":                                            auditExplicit(auditFacetMutation, "directory.user_create"),
	"GET /v1/directory/roles":                                             auditWrapped(auditFacetSensitiveRead),
	"POST /v1/directory/users/{id}/roles":                                 auditExplicit(auditFacetMutation, "directory.role_bind"),
	"DELETE /v1/directory/users/{id}/roles/{role}":                        auditExplicit(auditFacetMutation, "directory.role_unbind"),
