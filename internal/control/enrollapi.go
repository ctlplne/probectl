...
func collectorConfig(plane, tenantID, agentID, collectionProfile, busNamespace string) collectorConfigHint {
	...
	case "bgp":
		...
		h.Env["PROBECTL_BMP_REVOCATION_DATABASE_URL"] = "postgres://bmp_revocation@postgres:5432/probectl?sslmode=verify-full"
		...
		h.YAML["revocation_database_url"] = "postgres://bmp_revocation@postgres:5432/probectl?sslmode=verify-full"
