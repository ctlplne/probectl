...
var collectionPaginationContracts = map[string]string{
	...
	"/v1/alerts/maintenance":         "bounded",
	"/v1/alerts/{id}/evaluations":    "bounded",
	"/v1/incidents":                  "bounded",
	"/v1/changes":                    "bounded",
	"/v1/bgp/events":                 "bounded",
	"/v1/devices":                    "bounded",
	"/v1/device/identity-conflicts":  "bounded",
	"/v1/device/neighbors":           "bounded",
	"/v1/device/collection-outcomes": "bounded",
	"/v1/device/metrics":             "bounded",
	"/v1/device/syslog":              "bounded",
	...
	"/v1/results/history":            "bounded",
	"/v1/coverage/vantages":          "bounded",
	"/v1/coverage/debt":              "bounded",
	"/v1/otlp/traces":                "bounded",
	"/v1/otlp/logs":                  "bounded",
	"/v1/otlp-tokens":                "bounded",
	"/v1/rollouts":                   "bounded",
	"/v1/remediation/proposals":      "bounded",
	"/v1/dashboards":                 "bounded",
	"/v1/dashboard-report-schedules": "bounded",
	"/v1/dashboard-report-artifacts": "bounded",
}
