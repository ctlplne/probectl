...
var dataInventory = []DataInventoryEntry{
	...
	},
	{
		...
		DataClasses:    []Class{ClassPII, ClassConfidential, ClassInternal},
		Retention:      "metric samples follow TSDB retention; endpoint latest views follow derived identity retention; device-agent correlation labels follow PROBECTL_DEVICE_CORRELATION_RETENTION; durable inventory rows live while the tenant/identity is active",
		RetentionOwner: "internal/store/tsdb, internal/endpoint, device-agent correlation cache, and Postgres tenant tables",
		Processors: []string{
