...
var catalog = map[string]map[string]string{
	"en": {
		...
		"cli.ai.handoff.body_required":     "ai ask: --handoff requires --body with one Ask JSON object",
		"cli.ai.handoff.invalid_body":      "ai ask: invalid --body: {error}",
		"cli.ai.handoff.object_required":   "ai ask: --body must be one JSON object",
		"cli.ai.handoff.question_required": "ai ask: --body requires a non-empty question",
	},
	"es": {
		...
		"cli.ai.handoff.body_required":     "ai ask: --handoff requiere --body con un objeto JSON de Ask",
		"cli.ai.handoff.invalid_body":      "ai ask: --body no válido: {error}",
		"cli.ai.handoff.object_required":   "ai ask: --body debe ser un objeto JSON",
		"cli.ai.handoff.question_required": "ai ask: --body requiere una pregunta no vacía",
	},
	"ar": {
		...
		"cli.ai.handoff.body_required":     "ai ask: يتطلب --handoff تمرير كائن Ask بصيغة JSON عبر --body",
		"cli.ai.handoff.invalid_body":      "ai ask: قيمة --body غير صالحة: {error}",
		"cli.ai.handoff.object_required":   "ai ask: يجب أن تكون --body كائن JSON واحدا",
		"cli.ai.handoff.question_required": "ai ask: تتطلب --body سؤالا غير فارغ",
	},
}
