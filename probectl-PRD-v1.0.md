...
The repo's claims are enforced by **56 workflow jobs** across `.github/workflows/` (40 in the main CI workflow plus 16 nightly/release/security jobs); the notable standing gates:
