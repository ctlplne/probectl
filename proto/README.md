...
| `probectl/flow/v1/flow.proto` | `probectl.flow.v1` | `FlowRecord` / `FlowBatch` plus `FlowIngestQualityReceipt` / batch — device/cloud records and bounded secret-free per-exporter ingest health |
