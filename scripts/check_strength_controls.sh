...
need_pattern RESIL-S01 deploy/helm/probectl/templates/restore-job.yaml 'backoffLimit: 0|sha256sum -c|restore-work|backup-open|pg_restore|restore\.clickhouse\.serverBackupPath|RESTORE DATABASE'
need_pattern RESIL-S01 .github/workflows/ci.yml 'backup-restore-drill'
need_pattern RESIL-S01 cmd/probectl-control/backup_cli_contract_test.go 'TestBackupDrillExercisesSealedPBKPath|TestStandalonePostgresBackupsAreSealedOrBreakGlass|TestRestoreJobInvokesBackupOpenAsRealCLI|TestRestoreJobVerifiesChecksumBeforeMutatingPostgres|TestRestoreJobCorruptChecksumStopsBeforePostgresMutation|TestRestorePostgresRequiresChecksumBeforeMutation'
...
need_pattern EBPF-005 internal/ebpf/source_live_linux.go '[Vv]erifyObjectDigest\("l4flow"'
need_pattern EBPF-005 internal/ebpf/source_live_l7_linux.go '[Vv]erifyObjectDigest\(objName'
