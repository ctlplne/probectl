...
export interface DeviceSyslogRequest {
  device: string
  labels?: { [key: string]: string }
  message?: string
  observed_at?: string
...
export type ListDeviceConfigsResponse = DeviceConfigList

export interface ArchiveDeviceConfigRequest {
  body: DeviceConfigArchiveRequest
}
...
export type ListDeviceSyslogResponse = DeviceSyslogList

export interface IngestDeviceSyslogRequest {
  body: DeviceSyslogRequest
}

export type IngestDeviceSyslogResponse = DeviceSyslogEvent
...
export interface GetTenantIdentitySettingsRequest {
}

export type GetTenantIdentitySettingsResponse = TenantIdPSettings

export interface PutTenantIdentitySettingsRequest {
  body: TenantIdPSettingsInput
}
...
export class ProbectlSDKClient {
  ...
  async listDeviceConfigs(request: ListDeviceConfigsRequest = {}): Promise<ListDeviceConfigsResponse> {
    ...
    if (request.limit !== undefined) query.set("limit", String(request.limit))
    return this.requestJSON<ListDeviceConfigsResponse>("GET", path, query, undefined)
  }

  async archiveDeviceConfig(request: ArchiveDeviceConfigRequest): Promise<ArchiveDeviceConfigResponse> {
    let path = "/v1/device/configs"
    const query = new URLSearchParams()
  ...
  async listDeviceSyslog(request: ListDeviceSyslogRequest = {}): Promise<ListDeviceSyslogResponse> {
    let path = "/v1/device/syslog"
    const query = new URLSearchParams()
    if (request.device !== undefined) query.set("device", String(request.device))
    if (request.limit !== undefined) query.set("limit", String(request.limit))
    return this.requestJSON<ListDeviceSyslogResponse>("GET", path, query, undefined)
  }

  async ingestDeviceSyslog(request: IngestDeviceSyslogRequest): Promise<IngestDeviceSyslogResponse> {
    let path = "/v1/device/syslog"
    const query = new URLSearchParams()
    return this.requestJSON<IngestDeviceSyslogResponse>("POST", path, query, request.body)
  }
  ...
  async getTenantIdentitySettings(): Promise<GetTenantIdentitySettingsResponse> {
    let path = "/v1/identity/settings"
    const query = new URLSearchParams()
    return this.requestJSON<GetTenantIdentitySettingsResponse>("GET", path, query, undefined)
  }

  async putTenantIdentitySettings(request: PutTenantIdentitySettingsRequest): Promise<PutTenantIdentitySettingsResponse> {
    let path = "/v1/identity/settings"
    const query = new URLSearchParams()
