...
const DEMO_PATH: Path = {
  ...
  links: [
    { ttl: 1, from: '198.51.100.1', to: '198.51.100.21' },
    { ttl: 1, from: '198.51.100.1', to: '198.51.100.22' },
    { ttl: 1, from: '198.51.100.1', to: '198.51.100.23' },
    { ttl: 2, from: '198.51.100.21', to: '203.0.113.1' },
    { ttl: 2, from: '198.51.100.22', to: '203.0.113.1' },
    { ttl: 2, from: '198.51.100.23', to: '203.0.113.1' },
    { ttl: 3, from: '203.0.113.1', to: '192.0.2.9' },
