...
export const SURFACES: SurfaceDecl[] = [
  ...
  {
    capability:
      'Tenant data lifecycle and isolation visibility: retention, redacted export, residency, and erasure',
    featureIds: ['F34', 'F50', 'F55'],
    sprint: 'S-T5',
    kind: 'native',
    route: '/admin',
    evidence: [
      'file:web/src/routes/admin/LifecycleCards.tsx',
      'file:web/src/test/lifecycle.test.tsx',
      'openapi:/v1/isolation/status',
      'openapi:/v1/lifecycle/retention',
    ],
    liveReceipt: STATIC_NATIVE_RECEIPT,
  },
  {
    capability: 'Guarded remediation proposal review and explicit human approval',
    featureIds: ['F44'],
    sprint: 'S52',
    kind: 'native',
    route: '/admin',
    evidence: [
      'file:web/src/routes/admin/AdminCards.tsx',
      'file:web/src/test/remediation.test.tsx',
  ...
  {
    capability: 'Per-tenant encryption key chain, managed rotation, and BYOK activation',
    featureIds: ['F56'],
    sprint: 'S-T8',
    kind: 'native',
    route: '/admin',
    evidence: [
      'file:web/src/routes/admin/AdminCards.tsx',
      'file:web/src/test/keys.test.tsx',
      'openapi:/v1/security/keys',
      'openapi:/v1/security/keys/rotate',
    ],
    liveReceipt: STATIC_NATIVE_RECEIPT,
  },
  {
    capability: 'Change-intelligence candidates and evidence inspection in incident investigations',
    featureIds: ['F39'],
    sprint: 'S42',
    kind: 'native',
    route: '/incidents',
    evidence: [
      'file:web/src/routes/IncidentRoom.tsx',
      'file:web/src/test/incidents.test.tsx',
      'openapi:/v1/changes',
    ],
    liveReceipt: STATIC_NATIVE_RECEIPT,
  },
  {
    capability: 'Change overlays on bounded path investigations',
    featureIds: ['F39'],
    sprint: 'S42/X3',
    kind: 'native',
    route: '/path',
    evidence: [
      'file:web/src/routes/PathPage.tsx',
      'file:web/src/test/path-viz.test.tsx',
      'openapi:/v1/changes',
    ],
    liveReceipt: STATIC_NATIVE_RECEIPT,
  },
  {
    capability: 'Change and BGP evidence queries in the structured telemetry Explorer',
    featureIds: ['F39'],
    sprint: 'S42/X7',
    kind: 'native',
    route: '/explore',
    evidence: [
      'file:web/src/routes/ExplorerPage.tsx',
      'file:web/src/test/explorer.test.tsx',
      'openapi:/v1/explorer/query',
    ],
    liveReceipt: STATIC_NATIVE_RECEIPT,
  },
  ...
  {
    capability:
      'Provider console: ranked MSP operations, isolation lifecycle, showback, fairness, governance, and break-glass',
    featureIds: ['F34', 'F51', 'F52', 'F53', 'F57'],
    sprint: 'S-T1',
    kind: 'native',
    route: '/provider',
    offNav: true,
    evidence: [
      ...
      'file:web/src/test/provider-console.test.tsx',
  ...
  {
    capability:
      'Device telemetry, physical adjacency, topology attribution, and cross-source identity conflict review',
    ...
    evidence: [
      ...
      'openapi:/v1/device/neighbors',
      'openapi:/v1/device/collection-outcomes',
      ...
      'cli:probectl device neighbors',
      'cli:probectl device outcomes',
