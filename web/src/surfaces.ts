...
export const SURFACES: SurfaceDecl[] = [
  ...
  },
  {
    ...
    sprint: 'S13',
    kind: 'federated',
    evidence: ['file:analyzer', 'file:internal/bgp'],
  },
  {
    ...
    sprint: 'S32',
    kind: 'federated',
    evidence: ['file:docs/flow.md', 'openapi:/v1/flows/top', 'openapi:/v1/flows/anomalies'],
  },
  {
    ...
    sprint: 'S33',
    kind: 'federated',
    evidence: ['file:docs/device-telemetry.md', 'file:internal/device'],
  },
  {
    ...
    sprint: 'S31',
    kind: 'federated',
    evidence: ['file:docs/ebpf-agent.md', 'file:internal/ebpf'],
  },
  {
