...
const baselineFixtures: BaselineFixture[] = [
  ...
  },
  {
    ...
    outcome: {
      status: 'complete',
      evidence: [
        'four keyboard actions and zero pointer events or typed characters',
        'copied URL contains only a random share artifact ID',
        'authenticated replay restores clock, filters, selection, citations, and reasoning provenance',
      ],
    },
  },
  {
    ...
    activeTime: {
      min_ms: 60_000,
      max_ms: 180_000,
      basis: 'choose one taught canonical question and run it; two keyboard actions each',
    },
    outcome: {
      status: 'complete',
      evidence: [
        '10 of 10 canonical questions execute through one tenant-scoped surface',
        'two keyboard actions per answer and zero typed query characters',
